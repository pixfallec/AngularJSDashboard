...
function ($rootScope, $state, $stateParams) {
    ...
    $rootScope.app = {
        name: 'Australian City Analytics', // name of your project
        author: 'Team 21 - Cluster and Cloud Computing', // author's name or company name
        description: 'The University of Melbourne', // brief description
